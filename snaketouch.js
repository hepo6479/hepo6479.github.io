...
el_right.addEventListener('touchstart', function(event) {
...
el_left.addEventListener('touchstart', function(event) {
...
el_down.addEventListener('touchstart', function(event) {
